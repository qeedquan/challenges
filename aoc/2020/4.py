...
def main():
    passports = load("4.txt")
    print(solve(passports, valid1))
    print(solve(passports, valid2))
...
def load(name):
    ...
    for block in data.split('\n\n'):
        ...
        passports.append({match[0]: match[1] for match in matches})
    file.close()
    return passports

def solve(passports, valid):
