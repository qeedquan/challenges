...
def part2(points):
    ...
    for point in points:
        dist = manhattan((point[0], point[1]), (point[2], point[3]))
        solver.add(z3abs(x - point[0]) + z3abs(y - point[1]) > dist)
    solver.check()
