...
fn main() {
    assert_eq!(restore(3, 6, 5, 4), (1, 2, 3));
    assert_eq!(restore(40, 40, 40, 60), (20, 20, 20));
    assert_eq!(restore(201, 101, 101, 200), (1, 100, 100));
}

fn restore(x1: isize, x2: isize, x3: isize, x4: isize) -> (isize, isize, isize) {
