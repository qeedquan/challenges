...
function candies(a, b, c)
	return (a + b + c) ÷ 2
end

@assert(candies(1, 3, 4) == 4)
@assert(candies(1, 10, 100) == 55)
@assert(candies(10000000000000000, 10000000000000000, 10000000000000000) == 15000000000000000)
@assert(candies(23, 34, 45) == 51)
