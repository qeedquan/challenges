...
https://espresso.codeforces.com/18aa1573b5d0c49e178a230e693800b5a0c2e6a8.png
...
https://espresso.codeforces.com/9c98cd06c74ee783b366a57440a9ab57d0317193.png

Possible optimal arrangement of the lanterns for the 3-rd test case of input data example:

https://espresso.codeforces.com/ea550342416cdfaeadf987bfcfdab6d169d5f8ad.png
...
main(void)
{
	assert(lanterns(1, 1) == 1);
	assert(lanterns(1, 3) == 2);
	assert(lanterns(2, 2) == 2);
	assert(lanterns(3, 3) == 5);
	assert(lanterns(5, 3) == 8);
