...
double
last(double d, double L, double v1, double v2)
{
	return (L - d) / (v1 + v2);
}

void
test(double d, double L, double v1, double v2, double r)
{
	double p;
...
main(void)
{
	test(2, 6, 2, 2, 1.00000000000000000000);
	test(1, 9, 1, 2, 2.66666666666666650000);
