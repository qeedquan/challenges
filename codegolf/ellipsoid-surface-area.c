...
S=2πc^2 + 2π*a*b/sin(φ)*(E(φ,k)*sin^2(φ) + F(φ,k)*cos^2(φ)) where cosφ=c/a, k^2=[a^2*(b^2-c^2) / (b^2*(a^2-c^2))], a≥b≥c
...
S ≈ 4π * [(a^p*b^p + b^p*c^p + c^p*a^p) / (3 - k*(1 - 27*a*b*c/(a + b + c)^3))]^(1/p)

with empirical values of p=ln(2)/ln(π/2) and k=3/32.
