...
void
CSSdescramble(unsigned char *sec, unsigned char *key)
{
...
void
CSStitlekey1(unsigned char *key, unsigned char *im)
{
	unsigned int t1, t2, t3, t4, t5, t6;
	unsigned char k[5];
	int i;
...
void
CSStitlekey2(unsigned char *key, unsigned char *im)
{
	unsigned int t1, t2, t3, t4, t5, t6;
	unsigned char k[5];
	int i;
...
void
CSSdecrypttitlekey(unsigned char *tkey, unsigned char *dkey)
{
	int i;
	unsigned char im1[6];
