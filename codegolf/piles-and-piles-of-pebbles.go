...
I can emulate any language with my pebbles, and I want your code as small as possible because I have nothing but pebbles to keep track of it.
Thus this is code-golf, so the shortest code in each language wins.
