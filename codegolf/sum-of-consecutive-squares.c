...
main(void)
{
	static const uvlong tab[] = {
		5, 13, 14, 25, 29, 30, 41, 50, 54, 55, 61, 77, 85, 86, 90, 91, 110, 113,
		126, 135, 139, 140, 145, 149, 174, 181, 190, 194, 199, 203, 204, 221,
		230, 245, 255, 265, 271, 280, 284, 285, 294, 302, 313, 330, 355, 365,
		366, 371, 380, 384, 385, 415, 421, 434, 446, 451
	};
