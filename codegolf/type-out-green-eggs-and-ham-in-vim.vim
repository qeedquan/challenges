...
#
# Your task is to create a sequence of keystrokes that will result in the entire text of Green Eggs and Ham when applied to an empty file in the vim text editor, starting in normal mode with all default settings.
# Your keystrokes must not load any other files as part of their operation - all text must be generated within the editor itself.
#
