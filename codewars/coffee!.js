...
function coffee(sentence) {
	return sentence.replace(/\bcoffee\b/gi, 'COFFEE');
}

function main() {
	assert(coffee("Did I only have two cups of coffee this morning? I need more.") == "Did I only have two cups of COFFEE this morning? I need more.");
	assert(coffee("Coffee! Buy me a COFFEE!") == "COFFEE! Buy me a COFFEE!");
}
