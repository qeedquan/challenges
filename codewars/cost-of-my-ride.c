...
int
insurance(int age, const char *size, int numofdays)
{
	int price;
...
main()
{
	assert(insurance(18, "medium", 7) == 490);
	assert(insurance(30, "full-size", 30) == 1950);
	assert(insurance(21, "economy", -10) == 0);
	assert(insurance(42, "my custom car", 7) == 455);
