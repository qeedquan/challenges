...
Keys help React identify which items have changed, are added, or are removed. Keys should be given to the elements inside the array to give the elements a stable identityimport React from 'react';

*/

export const EggList = (props) => (
	<ul>
		{props.eggs.map((e, i) => (<EasterEgg name={e} key={i} />))}
	</ul>
);
