...
func main() {
	assert(wba([]int{3, 1, 2, 7, 1}, []int{1, 8, 4, 5, 2}) == [2]int{146, 134})
	assert(wba([]int{3, 1, 2, 7, 1, 11, 12, 3, 8, 1}, []int{1, 8, 4, 5, 2, 21, 5, 2, 2, 17}) == [2]int{1583, 1700})
	assert(wba([]int{3}, []int{2}) == [2]int{6, 0})
}
