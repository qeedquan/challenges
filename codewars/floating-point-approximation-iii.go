...
func main() {
	fmt.Println(solve(7, 4.00e+13, 8))
	fmt.Println(solve(9, 1.00e+14, 1))
	fmt.Println(solve(3, 3.00e+09, 1))
	fmt.Println(solve(7, 4.00e+09, 7))
}

func solve(_, b, c float64) float64 {
	return -c / b
}
