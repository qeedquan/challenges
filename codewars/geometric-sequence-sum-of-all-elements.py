...
def main():
    assert(geometric(2, 3, 5) == 242)
    assert(geometric(1, 1, 2) == 2)
    assert(geometric(2, 2, 10) == 2046)
    assert(geometric(1, -2, 10) == -341)
    assert(np.allclose(geometric(1, 0.5, 10), 1.998046875))
