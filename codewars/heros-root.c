...
vlong
guess(vlong n, vlong x)
{
	return floor((x + ((n * 1.0) / x)) / 2.0);
}

vlong
intrac(vlong n, vlong x0)
{
	vlong c, x;
...
main()
{
	assert(intrac(25, 1) == 4);
	assert(intrac(125348, 300) == 3);
	assert(intrac(125348981764, 356243) == 3);
