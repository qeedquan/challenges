...
func main() {
	assert(selnumber(0, 1) == 0)
	assert(selnumber(3, 1) == 0)
	assert(selnumber(13, 1) == 1)
	assert(selnumber(20, 2) == 2)
	assert(selnumber(30, 2) == 4)
	assert(selnumber(44, 2) == 6)
	assert(selnumber(50, 3) == 12)
	assert(selnumber(47, 3) == 12)
}
