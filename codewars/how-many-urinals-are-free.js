...
Have fun and don't pee into the wrong urinal ;)q
...
function getFreeUrinals(urinals) {
	...
	urinals = urinals.replace(/0?10?/g, '1');
	urinals = urinals.replace(/00/g, '0');
	urinals = urinals.replace(/1/g, '');
	return urinals.length;
}

assert(getFreeUrinals("10001") == 1);
assert(getFreeUrinals("1001") == 0);
assert(getFreeUrinals("00000") == 3);
assert(getFreeUrinals("0000") == 2);
assert(getFreeUrinals("01000") == 1);
