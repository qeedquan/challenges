...
Array.prototype.toDictionary = function (keyfn, valuefn = (value) => value) {
	return this.reduce((dict, value) => ((dict[keyfn(value)] = valuefn(value)), dict), {});
};

var array = [1, 2, 3, 4, 5];
console.log(array.toDictionary(k => k, v => true));
console.log(array.toDictionary(k => k, v => v*v));
console.log(array.toDictionary(k => k));
