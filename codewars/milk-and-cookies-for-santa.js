...
function main() {
	assert(timeForMilkAndCookies(new Date(2013, 11, 24)) == true);
	assert(timeForMilkAndCookies(new Date(2013, 0, 23)) == false);
	assert(timeForMilkAndCookies(new Date(3000, 11, 24)) == true);
}
