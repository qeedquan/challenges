...
assert(isMonotone([1, 2, 3]) == true);
assert(isMonotone([1, 1, 2]) == true);
assert(isMonotone([1])     == true);
assert(isMonotone([3, 2, 1]) == false);
assert(isMonotone([3, 2, 2]) == false);
assert(isMonotone([]) == true);
