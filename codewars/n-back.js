...
cognitive neuroscience to measure a part of working memory and working memory capacity.
...
function countTargets(n, sequence) {
	sequence = sequence.slice(n);
	let matches = sequence.filter((value, index) => 
		value === sequence[index]
	);
	return matches.length;
}

console.log(countTargets(1, [1, 1, 1]));
