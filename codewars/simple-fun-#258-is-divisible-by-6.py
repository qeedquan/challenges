...
def main():
    assert(gen("1*0") == ["120", "150", "180"])
    assert(gen("*1") == [])
    assert(gen("1234567890123456789012345678*0") == ["123456789012345678901234567800", "123456789012345678901234567830", "123456789012345678901234567860", "123456789012345678901234567890"])
