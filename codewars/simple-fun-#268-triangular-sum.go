...
func main() {
	assert(triangular_sum(6) == false)
	assert(triangular_sum(28) == false)
	assert(triangular_sum(45) == true)
	assert(triangular_sum(105) == false)
	assert(triangular_sum(136) == true)
	assert(triangular_sum(190) == false)
	assert(triangular_sum(210) == false)
	assert(triangular_sum(5050) == true)
	assert(triangular_sum(300) == false)
	assert(triangular_sum(2080) == true)
}
...
func triangular_sum(n int) bool {
