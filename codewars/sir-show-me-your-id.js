...
assert(showme("Francis") == true);
assert(showme("Jean-Eluard") == true);
assert(showme("Le Mec") == false);
assert(showme("Bernard-Henry-Levy") == true);
assert(showme("Mémé Gertrude") == false);
