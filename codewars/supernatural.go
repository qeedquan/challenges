...
...and you reply (return) with the info, and your signature saying of yours! Burn it alive, idjits!c
...
func main() {
	fmt.Println(bob("rugaru"))
}

func bob(monster string) string {
	...
	tactic, found := database[monster]
	if !found {
		tactic = "I have friggin no idea yet"
	}
	return fmt.Sprintf("%s, idjits!", tactic)
}
