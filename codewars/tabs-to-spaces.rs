...
fn main() {
    assert_eq!(tab2space("a\tbbb"), "a   bbb");
    assert_eq!(tab2space("aa\tbbb"), "aa  bbb");
    assert_eq!(tab2space("aaa\tb"), "aaa b");
    assert_eq!(tab2space("\tb"), "    b");
}

fn tab2space(s: &'static str) -> String {
