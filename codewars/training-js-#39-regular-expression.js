...
assert(regex.test("90000") == true);
assert(regex.test("-90000") == true);
assert(regex.test("900000000") == true);
assert(regex.test("91230000") == true);
assert(regex.test("-91230000") == true);

assert(regex.test("90001") == false);
assert(regex.test("9000") == false);
assert(regex.test("91230") == false);
assert(regex.test("1-90000") == false);
assert(regex.test("-90000123") == false);
