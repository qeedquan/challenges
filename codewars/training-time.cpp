...
void shuffle(vector<int> &array, const vector<pair<size_t, size_t>> &indices)
{
	for (auto index : indices)
		swap(array[index.first], array[index.second]);
}

void test(vector<int> &&array, const vector<pair<size_t, size_t>> &indices)
{
