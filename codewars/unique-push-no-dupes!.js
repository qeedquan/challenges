...
Write a function that will take an array and a person object as parameters.
The function will only push a "person" object onto the end of an array if someone with that phone number doesn't already exist in that array.
...
function uniquePush(array, object) {
	if (object.phoneNumber && array.every((other) => other.phoneNumber !== object.phoneNumber)) {
		array.push(object);
		return true;
	}
	return false;
