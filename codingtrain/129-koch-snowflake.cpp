...
void App::init()
{
	...
	if (!SDL_CreateWindowAndRenderer("Koch Snowflake", width, height, wflag, &window, &renderer))
...
void App::draw()
{
	...
	for (auto &segment : segments)
		SDL_RenderLine(renderer, segment.a.x, segment.a.y + 100, segment.b.x, segment.b.y + 100);
