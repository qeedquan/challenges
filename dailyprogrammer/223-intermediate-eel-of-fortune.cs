...
static class EelOfFortune
{
	...
	{
		Console.WriteLine(Problem("synchronized", "snond") == true);
		Console.WriteLine(Problem("misfunctioned", "snond") == true);
		Console.WriteLine(Problem("mispronounced", "snond") == false);
		Console.WriteLine(Problem("shotgunned", "snond") == false);
		Console.WriteLine(Problem("snond", "snond") == true);
	}
