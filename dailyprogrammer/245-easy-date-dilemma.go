...
func main() {
	assert(canon("2/13/15") == "2015-02-13")
	assert(canon("1-31-10") == "2010-01-31")
	assert(canon("5 10 2015") == "2015-05-10")
	assert(canon("2012 3 17") == "2012-03-17")
	assert(canon("2001-01-01") == "2001-01-01")
	assert(canon("2008/01/07") == "2008-01-07")
}
