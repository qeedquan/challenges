...
def main():
    assert(condense('I heard the pastor sing live verses easily.') == 'I heard the pastor sing liverses easily.')
    assert(condense('Deep episodes of Deep Space Nine came on the television only after the news.') == 'Deepisodes of Deep Space Nine came on the televisionly after the news.')
    assert(condense('Digital alarm clocks scare area children.') == 'Digitalarm clockscarea children.')
