...
func main() {
	test([]image.Point{{4, 4}, {0, 1}, {-2, 5}, {-6, 0}, {-1, -4}, {5, -2}, {4, 4}}, 55)
	test([]image.Point{{1, 1}, {0, 1}, {1, 0}, {1, 1}}, 0.5)
	test([]image.Point{{2, 1}, {5, 0}, {6, 4}, {4, 2}, {1, 3}}, 8)
	test([]image.Point{{0, 0}, {0, 1}, {1, 1}, {1, 0}}, 1)
