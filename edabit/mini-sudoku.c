...
main(void)
{
	...
	assert(isminisudoku(a1) == 1);
	assert(isminisudoku(a2) == 0);
	assert(isminisudoku(a3) == 0);
	assert(isminisudoku(a4) == 1);
	assert(isminisudoku(a5) == 0);
	assert(isminisudoku(a6) == 1);
	assert(isminisudoku(a7) == 1);
	assert(isminisudoku(a8) == 0);
