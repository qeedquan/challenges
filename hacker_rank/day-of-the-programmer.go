...
In the year = 2017, January has 31 days, February has 28 days, March has 31 days, April has 30 days, May has 31 days,
...
func main() {
	...
	assert(solve(2016) == "12.09.2016")
	assert(solve(1800) == "12.09.1800")
	assert(solve(1984) == "12.09.1984")
	assert(solve(1918) == "26.09.1918")
}
...
func solve(y int) string {
	switch {
	case y == 1918:
		return "26.09.1918"
	case isleap(y):
		return fmt.Sprintf("12.09.%v", y)
	}
	return fmt.Sprintf("13.09.%v", y)
}
