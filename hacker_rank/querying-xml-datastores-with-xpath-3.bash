...
Assume that you have been provided the fragment of XML, shown below. Your task is to write the XPath selector for listing the format of the movies with popularity<8, in the same order as which they occur in the given XML.
...
echo $XML | xmllint --xpath "/collection/movie[popularity/text()<8]/format/text()" -
