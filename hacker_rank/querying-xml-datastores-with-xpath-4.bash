...
Assume that you have been provided the fragment of XML, shown below. Your task is to write the XPath selector for picking up the popularity of the movie with the title "Trigun".
...
echo $XML | xmllint --xpath "/collection/movie[@title=\"Trigun\"]/popularity/text()" -
