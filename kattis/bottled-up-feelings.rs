...
The input consists of a single line containing three positive integers s, v1, v2, where s≤10^6 is the volume of the shipment, and v1,v2≤10^6 are the volumes of the two types of bottles, with v1>v2.
