...
fn main() {
    assert_eq!(categorize(1000, 35, 700, 300), "Heavy");
    assert_eq!(categorize(200, 50, 800, 50), "Neither");
}

fn categorize(length: isize, width: isize, height: isize, mass: isize) -> &'static str {
