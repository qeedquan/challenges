...
def main():
    assert(almost_equivalent("aaaa", "bccb") == False)
    assert(almost_equivalent("abcdeef", "abaaacc") == True)
    assert(almost_equivalent("cccddabba", "babababab") == True)
