...
func main() {
	fmt.Println(active([][2]int{{0, 5}, {1, 2}, {0, 2}, {0, 5}, {1, 3}}, 5))
	fmt.Println(active([][2]int{{1, 1}, {2, 2}, {2, 3}}, 4))
}

func active(logs [][2]int, k int) []int {
	uam := make(map[int]map[int]bool)
