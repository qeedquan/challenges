...
func main() {
	assert(solve([][2]int{{1, 2}, {2, 2}, {3, 3}, {1, 3}, {2, 3}}) == 3)
	assert(solve([][2]int{{1, 1}, {2, 1}, {3, 1}, {4, 2}, {5, 2}}) == 3)
	assert(solve([][2]int{{1, 1}, {1, 1}}) == 1)
	assert(solve([][2]int{}) == 0)
}
