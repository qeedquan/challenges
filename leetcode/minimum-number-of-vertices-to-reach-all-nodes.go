...
func main() {
	test(
		6, [][2]int{{0, 1}, {0, 2}, {2, 5}, {3, 4}, {4, 2}},
		[]int{0, 3},
	)

	test(
		5, [][2]int{{0, 1}, {2, 1}, {3, 1}, {1, 4}, {2, 4}},
		[]int{0, 2, 3},
	)
}
...
func test(nodes int, edges [][2]int, expected []int) {
	result := vertices(nodes, edges)
	fmt.Println(result)
	assert(reflect.DeepEqual(result, expected))
}

func vertices(nodes int, edges [][2]int) []int {
