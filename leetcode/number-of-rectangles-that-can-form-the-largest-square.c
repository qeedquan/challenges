...
main()
{
	int r1[][2] = { { 5, 8 }, { 3, 9 }, { 5, 12 }, { 16, 5 } };
	int r2[][2] = { { 2, 3 }, { 3, 7 }, { 4, 3 }, { 3, 7 } };
	int r3[][2] = { { 4, 6 } };

	assert(count(r1, nelem(r1)) == 3);
	assert(count(r2, nelem(r2)) == 3);
	assert(count(r3, nelem(r3)) == 1);
