...
main(void)
{
	...
	assert(issquare(s1[0], s1[1], s1[2], s1[3]) == true);
	assert(issquare(s2[0], s2[1], s2[2], s2[3]) == false);
	assert(issquare(s3[0], s3[1], s3[2], s3[3]) == false);
	assert(issquare(s4[0], s4[1], s4[2], s4[3]) == true);
	assert(issquare(s5[0], s5[1], s5[2], s5[3]) == false);
	assert(issquare(s6[0], s6[1], s6[2], s6[3]) == false);
	assert(issquare(s7[0], s7[1], s7[2], s7[3]) == true);
	assert(issquare(s8[0], s8[1], s8[2], s8[3]) == true);
	assert(issquare(s9[0], s9[1], s9[2], s9[3]) == true);
	assert(issquare(s10[0], s10[1], s10[2], s10[3]) == true);
	assert(issquare(s10[0], s10[3], s10[1], s10[2]) == true);
	assert(issquare(s11[0], s11[3], s11[1], s11[2]) == true);
