...
func main() {
	assert(score([]int{1000, 342, 0}) == 342)
	assert(score([]int{2, 2, 9, 11, 932}) == 7)
	assert(score([]int{300, 1000, 0, 200, 400}) == 300)
	assert(score([]int{353, 242, 402, 274, 283, 132, 402, 523}) == 326)
}
