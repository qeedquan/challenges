...
void
load_mesh_obj_data(mesh_t *mesh, char *obj_filename)
{
	FILE *file;
...
void
load_mesh_png_data(mesh_t *mesh, char *png_filename)
{
...
void
load_mesh(char *obj_filename, char *png_filename, vec3_t scale, vec3_t translation, vec3_t rotation)
{
...
void
rotate_mesh_x(int mesh_index, float angle)
{
	meshes[mesh_index].rotation.x += angle;
}

void
rotate_mesh_y(int mesh_index, float angle)
{
	meshes[mesh_index].rotation.y += angle;
}

void
rotate_mesh_z(int mesh_index, float angle)
{
